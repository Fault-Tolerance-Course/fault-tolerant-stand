...
const (
	AdService_GetAd_FullMethodName      = "/api_gateway.ad.v1.AdService/GetAd"
	AdService_ListAds_FullMethodName    = "/api_gateway.ad.v1.AdService/ListAds"
	AdService_CreateAd_FullMethodName   = "/api_gateway.ad.v1.AdService/CreateAd"
	AdService_Deactivate_FullMethodName = "/api_gateway.ad.v1.AdService/Deactivate"
)
...
func (c *adServiceClient) Deactivate(ctx context.Context, in *DeactivateRequest, opts ...grpc.CallOption) (*DeactivateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeactivateResponse)
	err := c.cc.Invoke(ctx, AdService_Deactivate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAdServiceServer) Deactivate(context.Context, *DeactivateRequest) (*DeactivateResponse, error) {
...
func _AdService_Deactivate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeactivateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdServiceServer).Deactivate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdService_Deactivate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdServiceServer).Deactivate(ctx, req.(*DeactivateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api_gateway.ad.v1.AdService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AdService_Deactivate_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api-gateway/ad/v1/ad.proto",
}
